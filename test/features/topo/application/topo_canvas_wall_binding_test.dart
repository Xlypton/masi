...
void main() {
  ...
  test('A2: attaching a photo to a wall goes through '
      ...
      'Area/Sector/Wall is created as a side effect', () async {
    final container = makeContainer();
    final crud = container.read(libraryCrudRepositoryProvider);
    ...
    expect(
      reloaded.wallId,
      wall.id,
      reason: 'must belong to the navigated wall',
    );
  ...
  test('T2: after entering photo-less wall B (activeWallId null), '
