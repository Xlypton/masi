...
// any more.
//
// This file stays in place and re-exports both screens so every existing
// importer — `router.dart` and the community test suite — keeps resolving
// with NO edit required.
export 'community_feed_screen.dart' show CommunityFeedScreen;
export 'community_map_screen.dart' show CommunityMapScreen;
